...
def get_location(vehicleID=None):
    ...
    if cache_hit:
        ...
        if DEBUG:
            print("fetching")
        base_url = os.environ.get('LOCSIM_URL') # base_url = "http://locsim-svc-service:6200". Another endpoint useful during testing is "https://postman-echo.com/get?vehicleID={}"
        path = "/get_location"
        url = base_url + path
