...
* Docker images corresponding to 
  * preprocessor/rtsp_preprocessor.py - dtfernando/ianomaly:preprocess
  * face_detector/face_detection_app.py - dtfernando/ianomaly:face_detect
  * face_recognizer/face_recognition_app.py - dtfernando/ianomaly:face_recog